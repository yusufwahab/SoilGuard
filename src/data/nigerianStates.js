// Nigeria's 36 states + FCT, each mapped to its capital city. Used as the
// geocoding query when a farmer picks a state from the Settings dropdown --
// Open-Meteo's geocoding API matches actual place names, not "X State"
// queries, so we geocode the capital and label it with the state name.
