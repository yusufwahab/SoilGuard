...
export default function WeatherWidget() {
  ...
  if (status === "no-location") {
    return (
      <div className="flex items-center gap-2.5 text-xs text-surface-400 bg-surface-100/60 border border-surface-200 rounded-xl px-4 py-3 mb-6">
        <span className="text-lg" role="img" aria-label="globe">🌍</span>
        <span>Set your farm location in Settings to see live weather here.</span>
      </div>
    );
  }
